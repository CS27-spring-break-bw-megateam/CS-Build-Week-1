...
def move(request):
    ...
    if nextRoomID is not None and nextRoomID > 0:
        ...
        return JsonResponse({'name':player.user.username, 'title':nextRoom.title, 'description':nextRoom.description, 'players':players, 'x':nextRoom.x, 'y':nextRoom.y,'error_msg':""}, safe=True)
    else:
        players = room.playerNames(player_id)
